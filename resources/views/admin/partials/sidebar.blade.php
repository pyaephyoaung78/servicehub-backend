<aside
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-5" aria-label="Admin navigation">
        ...
        <a
            ...
            @class([ 'mb-1 flex items-center rounded-lg px-3 py-2.5 text-sm font-medium transition focus:outline-none focus:ring-2 focus:ring-teal-400' , 'bg-teal-600 text-white shadow-sm'=> request()->routeIs('admin.loyalty.*'),
            'text-slate-300 hover:bg-slate-800 hover:text-white' => ! request()->routeIs('admin.loyalty.*'),
            ])
            >
            Loyalty Program
        </a>
